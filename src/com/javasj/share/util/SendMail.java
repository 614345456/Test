...
*/		
		...
		String from = "unmey@sina.com";// 邮件显示名称
		String to = "unmey@qq.com";// 收件人的邮件地址，必须是真实地址
//		String to = "634635833@qq.com";// 收件人的邮件地址，必须是真实地址
		String copyto = "";// 抄送人邮件地址
		String subject = "万家乐官方网站留言回复";// 邮件标题
		String content = "你好你好！";// 邮件内容
//		String username = "万家乐官方网站留言回复";// 发件人真实的账户名
		String username = "unmey@sina.com";// 发件人真实的账户名
		String password = "521521wsy";// 发件人密码
